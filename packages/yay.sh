...
if command -v yay &>/dev/null; then
   ALL_APPS=("google-chrome" "visual-studio-code-bin" "slack-desktop" "android-studio" "vlc" "discord" "ardour" "postman" "spotify" "docker" "docker-compose" "docker-desktop" "onlyoffice-bin")
